    ...
    <div style={{ minHeight: "100vh", background: "#08080C", fontFamily: "'Inter', sans-serif", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ width: "100%", maxWidth: 420, padding: "0 24px", animation: "fadeIn 0.4s ease" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <div style={{ width: 64, height: 64, borderRadius: 18, background: "#EEF2FF", border: "0.5px solid #D0C8F5", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
          ...
          <div style={{ fontSize: 26, fontWeight: 600, color: "#fff", letterSpacing: "-0.5px" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 20, padding: "36px 32px" }}>
          ...
          {loading ? (
            ...
            <>
              <button onClick={handleGoogleLogin} style={{ width: "100%", padding: "13px 20px", borderRadius: 12, background: "#fff", border: "1px solid rgba(255,255,255,0.1)", display: "flex", alignItems: "center", justifyContent: "center", gap: 12, cursor: "pointer", transition: "all 0.2s", marginBottom: 16 }}
